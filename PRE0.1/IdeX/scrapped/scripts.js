...
// Function to handle the click event for creating a new project
function handleCreateProjectClick() {
    // Simulate creating a new project (replace with actual logic)
    const projectName = 'New Project'; // Example project name

    // Create a new list item for the project
    const newProjectItem = document.createElement('li');
    newProjectItem.textContent = projectName;

    // Add click event listener to navigate to the main IDE workspace when project is clicked
    newProjectItem.addEventListener('click', () => {
        // Simulate navigating to the main IDE workspace (replace with actual navigation logic)
        navigateToIDE(projectName);
    });

    // Add the new project item to the list of recent projects
    const recentProjectsList = document.getElementById('recent-projects');
    recentProjectsList.appendChild(newProjectItem);
}

// Function to navigate to the main IDE workspace with the specified project
function navigateToIDE(projectName) {
    // Simulate navigating to the main IDE workspace (replace with actual navigation logic)
    console.log(`Navigating to IDE with project: ${projectName}`);
    // Redirect to the IDE page or perform other actions as needed
}
